...
definePageMeta({
    title: 'Contact details card',
    layout: 'docs',
    overtitle: 'Components',
    description: 'Displays a user’s contact information in a structured card layout, typically used in profiles, directories, or support views.',
})
