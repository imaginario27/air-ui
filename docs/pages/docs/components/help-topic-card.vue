...
definePageMeta({
    title: 'Help topic card',
    layout: 'docs',
    overtitle: 'Components',
    description: 'Displays a summary of a help topic or article, typically used in support sections to guide users toward relevant information.',
})
