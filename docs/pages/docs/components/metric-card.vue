...
definePageMeta({
    ...
    description: 'Displays a key metric or data point in a concise card format, often used in dashboards and analytics views to highlight performance indicators.',
})
